...
sys.path.insert(0,'/sdcard/mat lab/CoordGeo')         #path to my scripts
...
#if using termux
plt.savefig('/sdcard/mat lab/CoordGeo/figs1.pdf')
subprocess.run(shlex.split("termux-open /sdcrad/mat lab/CoordGeo/figs1.pdf"))
#else
#plt.show();
